...
lemmas fst_nat_eq = HTHN.fst_nat_eq_unfolded[simplified case_prod_nat_def]
compile_nat fst_nat_eq
HOL_To_IMP_Minus_correct HOL_To_HOL_Nat.fst_nat by cook

lemmas snd_nat_eq = HTHN.snd_nat_eq_unfolded[simplified case_prod_nat_def]
compile_nat snd_nat_eq
HOL_To_IMP_Minus_correct HOL_To_HOL_Nat.snd_nat by cook

compile_nat HTHN.rpair_nat_eq_unfolded
HOL_To_IMP_Minus_correct HOL_To_HOL_Nat.rpair_nat by cook
