...
record IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_state =
  IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_s::nat
  IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_n::nat
  IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_r::nat
  IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_vp::nat
  IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_k::nat
  IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_ret::nat

abbreviation "IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_prefix \<equiv> ''IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1.''"
abbreviation "IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_s_str \<equiv> ''s''"
abbreviation "IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_n_str \<equiv> ''n''"
abbreviation "IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_r_str \<equiv> ''r''"
abbreviation "IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_vp_str \<equiv> ''vp''"
abbreviation "IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_k_str \<equiv> ''k''"
abbreviation "IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_ret_str \<equiv> ''ret''"

definition "IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_state_upd s \<equiv>
  (let
      LESS_EQUAL_neq_zero_a' = IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_n s;
      LESS_EQUAL_neq_zero_b' = IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_k s;
  ...
  (let
      ...
      ret = \<lparr>IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_s = IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_s s,
             IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_n = IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_n s,
             IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_r = IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_r s,
             IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_vp = IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_vp s,
             IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_k = IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_k s,
  ...
  (let
      LESS_neq_zero_a' = IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_k s;
      LESS_neq_zero_b' = IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_r s;
      LESS_neq_zero_ret' = 0;
  ...
  (let
      map_IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_k' = IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_k s;
      map_IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_ys' = IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_s s;
      map_IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_ret' = 0;
      map_IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_state =
        \<lparr>map_IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_k = map_IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_k',
         map_IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_ys = map_IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_ys',
         map_IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_ret = map_IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_ret'\<rparr>;
      map_IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_ret_state = 
        map_IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_imp map_IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_state;
      map_list_find_aux_xs' = map_IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_ret map_IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_ret_state;
      map_list_find_aux_a' = IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_vp s;
      ...
      IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_ret' = map_list_find_aux_ret map_list_find_aux_ret_state;
      ret = \<lparr>IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_s = IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_s s,
             IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_n = IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_n s,
             IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_r = IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_r s,
             IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_vp = IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_vp s,
  ...
  (let
      IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_ret' = 1;
      ret = \<lparr>IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_s = IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_s s,
             IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_n = IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_n s,
             IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_r = IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_r s,
             IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_vp = IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_vp s,
...
function IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_imp ::
  "IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_state \<Rightarrow> IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_state" where
  "IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_imp s =
  (let 
      ret = IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_state_upd s
    in 
      ret
  )"
  by simp+
termination
  by (relation "measure IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_s") simp

declare IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_imp.simps [simp del]

lemma IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_imp_correct[let_function_correctness]:
  "IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_ret (IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_imp s) =
    IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1 
      (IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_s s) (IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_n s)
      (IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_r s) (IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_vp s)
      (IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_k s)"
  apply (simp only: IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_imp.simps Let_def
  IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_state_upd_def LESS_EQUAL_neq_zero_imp_correct
  LESS_neq_zero_imp_correct map_IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_imp_correct
  map_list_find_aux_imp_correct)
  by simp  

function IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_imp_time ::
  "nat \<Rightarrow> IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_state \<Rightarrow> nat" where
  "IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_imp_time t s =
  (let
      LESS_EQUAL_neq_zero_a' = IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_n s;
      t = t + 2;
      LESS_EQUAL_neq_zero_b' = IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_k s;
  ...
  (let
      ...
      map_IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_ret_state = 
        map_IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_imp map_IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_state;
      t = t + map_IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_imp_time 0 map_IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_state;
      map_list_find_aux_xs' = map_IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_ret map_IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_ret_state;
      t = t + 2;
      map_list_find_aux_a' = IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_vp s;
      t = t + 2;
  ...
  by auto
termination
  by (relation "measure (IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_s \<circ> snd)") simp

declare IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_imp_time.simps [simp del]

lemma IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_imp_time_acc:
  "(IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_imp_time (Suc t) s) = Suc (IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_imp_time t s)"
  by (induction t s rule: IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_imp_time.induct)
    ((subst (1 2) IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_imp_time.simps);
      (simp add: IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_state_upd_def Let_def))            

lemma IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_imp_time_acc_2_aux:
  "(IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_imp_time t s) = t + (IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_imp_time 0 s)"
  by (induction t arbitrary: s) (simp add: IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_imp_time_acc)+            

lemma IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_imp_time_acc_2:
  "t \<noteq> 0 \<Longrightarrow> (IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_imp_time t s) = t + (IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_imp_time 0 s)"
  by (rule IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_imp_time_acc_2_aux)            

lemma IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_imp_time_acc_3:
  "(IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_imp_time (a + b) s) = a + (IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_imp_time b s)"
  by (induction a arbitrary: b s) (simp add: IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_imp_time_acc)+            

abbreviation "IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_LESS_EQUAL_neq_zero_result \<equiv> ''LESS_EQUAL_neq_zero_result''"
abbreviation "IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_LESS_neq_zero_result \<equiv> ''LESS_neq_zero_result''"

abbreviation "IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_IMP_if1 \<equiv>
  \<comment> \<open>  map_IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_k' = IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_k s;\<close>
  (map_IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_prefix @ map_IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_k_str) ::=
    (A (V IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_k_str));;
  \<comment> \<open>  map_IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_ys' = IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_s s;\<close>
  (map_IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_prefix @ map_IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_ys_str) ::=
    (A (V IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_s_str));;
  \<comment> \<open>  map_IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_ret' = 0;\<close>
  (map_IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_prefix @ map_IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_ret_str) ::=
    (A (N 0));;
  \<comment> \<open>  map_IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_state =\<close>
  \<comment> \<open>    \<lparr>map_IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_k = map_IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_k',\<close>
  \<comment> \<open>     map_IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_ys = map_IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_ys',\<close>
  \<comment> \<open>     map_IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_ret = map_IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_ret'\<rparr>;\<close>
  \<comment> \<open>  map_IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_ret_state = \<close>
  \<comment> \<open>    map_IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_imp map_IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_state;\<close>
  (invoke_subprogram map_IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_prefix map_IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_IMP_Minus);;
  \<comment> \<open>  map_list_find_aux_xs' = map_IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_ret map_IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_ret_state;\<close>
  (map_list_find_aux_prefix @ map_list_find_aux_xs_str) ::= 
    (A (V (map_IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_prefix @ map_IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_ret_str)));;
  \<comment> \<open>  map_list_find_aux_a' = IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_vp s;\<close>
  (map_list_find_aux_prefix @ map_list_find_aux_a_str) ::= (A (V IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_vp_str));;
  ...
  \<comment> \<open>  IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_ret' = map_list_find_aux_ret map_list_find_aux_ret_state;\<close>
  (IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_ret_str) ::= (A (V (map_list_find_aux_prefix @ map_list_find_aux_ret_str)))
"

abbreviation "IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_IMP_else1 \<equiv>
  \<comment> \<open>  IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_ret' = 1;\<close>
  (IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_ret_str) ::= (A (N 1))
"

abbreviation "IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_IMP_if2 \<equiv>
  \<comment> \<open>  IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_ret' = 0;\<close>
  (IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_ret_str) ::= (A (N 0))
"

abbreviation "IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_IMP_else2 \<equiv>
  \<comment> \<open>  LESS_neq_zero_a' = IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_k s;\<close>
  (LESS_neq_zero_prefix @ LESS_neq_zero_a_str) ::= (A (V IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_k_str));;
  \<comment> \<open>  LESS_neq_zero_b' = IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_r s;\<close>
  (LESS_neq_zero_prefix @ LESS_neq_zero_b_str) ::= (A (V IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_r_str));;
  ...
  (IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_LESS_neq_zero_result) ::= (A (V (LESS_neq_zero_prefix @ LESS_neq_zero_ret_str)));;
  \<comment> \<open>(if LESS_neq_zero_result \<noteq> 0 then\<close>
  (IF IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_LESS_neq_zero_result \<noteq>0 THEN
    IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_IMP_if1
  \<comment> \<open>else\<close>
  ELSE
    IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_IMP_else1
  )
"

definition IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_IMP_Minus where
  "IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_IMP_Minus \<equiv>
  \<comment> \<open>  LESS_EQUAL_neq_zero_a' = IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_n s;\<close>
  (LESS_EQUAL_neq_zero_prefix @ LESS_EQUAL_neq_zero_a_str) ::= (A (V IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_n_str));;
  \<comment> \<open>  LESS_EQUAL_neq_zero_b' = IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_k s;\<close>
  (LESS_EQUAL_neq_zero_prefix @ LESS_EQUAL_neq_zero_b_str) ::= (A (V IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_k_str));;
  ...
  (IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_LESS_EQUAL_neq_zero_result) ::= (A (V (LESS_EQUAL_neq_zero_prefix @ LESS_EQUAL_neq_zero_ret_str)));;
  \<comment> \<open>(if LESS_EQUAL_neq_zero_result \<noteq> 0 then\<close>
  (IF IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_LESS_EQUAL_neq_zero_result \<noteq>0 THEN
    IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_IMP_if2
  \<comment> \<open>else\<close>
  ELSE
    IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_IMP_else2
  )
"

abbreviation "IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_IMP_vars \<equiv>
  {IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_s_str, IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_n_str,
  IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_r_str, IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_vp_str,
  IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_k_str, IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_ret_str,
  IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_LESS_EQUAL_neq_zero_result,
  IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_LESS_neq_zero_result}"

definition "IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_imp_to_HOL_state p s =
  \<lparr>IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_s = (s (add_prefix p IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_s_str)),
   IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_n = (s (add_prefix p IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_n_str)),
   IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_r = (s (add_prefix p IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_r_str)),
   IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_vp = (s (add_prefix p IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_vp_str)),
   IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_k = (s (add_prefix p IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_k_str)),
   IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_ret = (s (add_prefix p IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_ret_str))\<rparr>"

lemmas IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_state_translators =
...
lemma IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_IMP_Minus_correct_function:
  "(invoke_subprogram p IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_IMP_Minus, s) \<Rightarrow>\<^bsup>t\<^esup> s' \<Longrightarrow>
     s' (add_prefix p IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_ret_str)
      = IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_ret
          (IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_imp (IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_imp_to_HOL_state p s))"
  apply(subst IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_imp.simps)
  apply(simp only: IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_IMP_Minus_def prefix_simps)
  apply(erule Seq_E)+
  apply(erule LESS_EQUAL_neq_zero_IMP_Minus_correct[where vars = "IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_IMP_vars"])
  subgoal premises p using p(6) by fastforce
  apply(erule If_E)
  subgoal
    by(fastforce simp: IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_state_translators
       IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_state_upd_def)    
  subgoal
    apply(erule Seq_E)+
    apply(erule LESS_neq_zero_IMP_Minus_correct[where vars = "IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_IMP_vars"])
    subgoal premises p using p(14) by fastforce
    apply(erule If_E)
    subgoal
      apply(erule Seq_E)+
      apply(erule map_IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_IMP_Minus_correct[where vars = "IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_IMP_vars"])
      subgoal premises p using p(25) by fastforce
      apply(erule map_list_find_aux_IMP_Minus_correct[where vars = "IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_IMP_vars"])
...
lemma IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_IMP_Minus_correct_effects:
  "\<lbrakk>(invoke_subprogram (p @ IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_pref) IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_IMP_Minus, s) \<Rightarrow>\<^bsup>t\<^esup> s';
    v \<in> vars; \<not> (prefix IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_pref v)\<rbrakk>
   \<Longrightarrow> s (add_prefix p v) = s' (add_prefix p v)"
  using com_add_prefix_valid'' com_only_vars prefix_def
  by blast   

lemma IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_IMP_Minus_correct_time:
  "(invoke_subprogram p IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_IMP_Minus, s) \<Rightarrow>\<^bsup>t\<^esup> s' \<Longrightarrow>
     t = IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_imp_time 0 (IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_imp_to_HOL_state p s)"
  apply(subst IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_imp_time.simps)
  apply(simp only: IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_IMP_Minus_def prefix_simps)
  apply(erule Seq_tE)+
  apply(erule LESS_EQUAL_neq_zero_IMP_Minus_correct[where vars = "IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_IMP_vars"])
  subgoal premises p using p(11) by fastforce
  apply(erule If_tE)
  subgoal
    by(fastforce simp add: Let_def IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_state_translators) 
  subgoal
    apply(erule Seq_tE)+
    apply(erule LESS_neq_zero_IMP_Minus_correct[where vars = "IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_IMP_vars"])
    subgoal premises p using p(25) by fastforce
...
lemma IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_IMP_Minus_correct:
  "\<lbrakk>(invoke_subprogram (p1 @ p2) IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_IMP_Minus, s) \<Rightarrow>\<^bsup>t\<^esup> s';
    \<And>v. v \<in> vars \<Longrightarrow> \<not> (set p2 \<subseteq> set v);
    \<lbrakk>t = (IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_imp_time 0 (IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_imp_to_HOL_state (p1 @ p2) s));
     s' (add_prefix (p1 @ p2) IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_ret_str) =
          IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_ret (IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_imp
                                        (IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_imp_to_HOL_state (p1 @ p2) s));
     \<And>v. v \<in> vars \<Longrightarrow> s (add_prefix p1 v) = s' (add_prefix p1 v)\<rbrakk>
   \<Longrightarrow> P\<rbrakk> \<Longrightarrow> P"
  using IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_IMP_Minus_correct_function
    IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux1_IMP_Minus_correct_time
...
record IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_state =
  IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_n::nat
  IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_v::nat
  IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_po::nat
  IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_vo::nat
  IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_ko::nat
  IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_ret::nat

abbreviation "IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_prefix \<equiv> ''IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2.''"
abbreviation "IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_n_str \<equiv> ''n''"
abbreviation "IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_v_str \<equiv> ''v''"
abbreviation "IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_po_str \<equiv> ''po''"
abbreviation "IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_vo_str \<equiv> ''vo''"
abbreviation "IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_ko_str \<equiv> ''ko''"
abbreviation "IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_ret_str \<equiv> ''ret''"

definition "IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_state_upd s \<equiv>
  (let
      EQUAL_neq_zero_a' = IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_vo s;
      ...
      EQUAL_neq_zero_state = \<lparr>EQUAL_neq_zero_a = EQUAL_neq_zero_a',
                              ...
                              EQUAL_neq_zero_ret = EQUAL_neq_zero_ret'\<rparr>;
      EQUAL_neq_zero_ret_state = EQUAL_neq_zero_imp EQUAL_neq_zero_state;
      AND_neq_zero_a' = IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_po s;
      AND_neq_zero_b' = EQUAL_neq_zero_ret EQUAL_neq_zero_ret_state;
      AND_neq_zero_ret' = 0;
      AND_neq_zero_state = \<lparr>AND_neq_zero_a = AND_neq_zero_a',
                            AND_neq_zero_b = AND_neq_zero_b',
  ...
  (if AND_neq_zero_result \<noteq> 0 then
  (let 
      LESS_neq_zero_a' = IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_ko s;
      LESS_neq_zero_b' = IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_n s;
      LESS_neq_zero_ret' = 0;
      LESS_neq_zero_state = \<lparr>LESS_neq_zero_a = LESS_neq_zero_a',
                             LESS_neq_zero_b = LESS_neq_zero_b',
                             LESS_neq_zero_ret = LESS_neq_zero_ret'\<rparr>;
  ...
  (if LESS_neq_zero_result \<noteq> 0 then
  (let 
      IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_ret' = 1;
      ret = \<lparr>IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_n = IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_n s,
             IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_v = IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_v s,
             IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_po = IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_po s,
             IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_vo = IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_vo s,
             IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_ko = IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_ko s,
  ...
  (let 
      IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_ret' = 0;
      ret = \<lparr>IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_n = IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_n s,
             IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_v = IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_v s,
             IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_po = IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_po s,
             IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_vo = IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_vo s,
...
function IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_imp ::
  ...
  "IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_imp s =
  (let 
      ret = IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_state_upd s
    in 
      ret
  )"
  by simp+
termination
  by (relation "measure IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_n") simp

declare IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_imp.simps [simp del]

lemma IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_imp_correct[let_function_correctness]:
  "IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_ret (IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_imp s) =
    IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2 
      (IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_n s) (IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_v s)
      (IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_po s) (IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_vo s)
      (IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_ko s)"
  apply (simp only: IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_imp.simps Let_def
  IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_state_upd_def EQUAL_neq_zero_imp_correct
  AND_neq_zero_imp_correct LESS_neq_zero_imp_correct carry_vname_encode_val b_encode_char_val
  IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2.simps)
  by simp

function IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_imp_time ::
  "nat \<Rightarrow> IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_state \<Rightarrow> nat" where
  "IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_imp_time t s =
  (let
      EQUAL_neq_zero_a' = IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_vo s;
      t = t + 2;
      EQUAL_neq_zero_b' = b_encode_char_as_nat;
...
declare IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_imp_time.simps [simp del]

lemma IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_imp_time_acc:
  "(IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_imp_time (Suc t) s) = Suc (IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_imp_time t s)"
  by (induction t s rule: IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_imp_time.induct)
    ((subst (1 2) IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_imp_time.simps);
      (simp add: IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_state_upd_def Let_def))            

lemma IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_imp_time_acc_2_aux:
  "(IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_imp_time t s) = t + (IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_imp_time 0 s)"
  by (induction t arbitrary: s) (simp add: IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_imp_time_acc)+            

lemma IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_imp_time_acc_2:
  "t \<noteq> 0 \<Longrightarrow> (IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_imp_time t s) = t + (IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_imp_time 0 s)"
  by (rule IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_imp_time_acc_2_aux)            

lemma IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_imp_time_acc_3:
  "(IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_imp_time (a + b) s) = a + (IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_imp_time b s)"
  by (induction a arbitrary: b s) (simp add: IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_imp_time_acc)+    

abbreviation "IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_AND_neq_zero_result \<equiv> ''AND_neq_zero_result''"
abbreviation "IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_LESS_neq_zero_result \<equiv> ''LESS_neq_zero_result''"
abbreviation "IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_EQUAL_neq_zero_result \<equiv> ''EQUAL_neq_zero_result''"

abbreviation "IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_IMP_if1 \<equiv>
  \<comment> \<open>  IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_ret' = 1;\<close>
  (IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_ret_str) ::= (A (N 1))
"

abbreviation "IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_IMP_else1 \<equiv>
  \<comment> \<open>  IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_ret' = 0;\<close>
...
abbreviation "IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_IMP_if2 \<equiv>
  ...
  (LESS_neq_zero_prefix @ LESS_neq_zero_b_str) ::= (A (V IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_n_str));;
  \<comment> \<open>  LESS_neq_zero_ret' = 0;\<close>
  (LESS_neq_zero_prefix @ LESS_neq_zero_ret_str) ::= (A (N 0));;
  \<comment> \<open>  LESS_neq_zero_state = \<lparr>LESS_neq_zero_a = LESS_neq_zero_a',\<close>
  \<comment> \<open>                         LESS_neq_zero_b = LESS_neq_zero_b',\<close>
  ...
  (invoke_subprogram LESS_neq_zero_prefix LESS_neq_zero_IMP_Minus);;
  \<comment> \<open>  LESS_neq_zero_result = LESS_neq_zero_ret LESS_neq_zero_ret_state\<close>
  (IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_LESS_neq_zero_result) ::= (A (V (LESS_neq_zero_prefix @ LESS_neq_zero_ret_str)));;
  \<comment> \<open>(if LESS_neq_zero_result \<noteq> 0 then\<close>
  (IF IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_LESS_neq_zero_result \<noteq>0 THEN
    IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_IMP_if1
  \<comment> \<open>else\<close>
  ELSE
    IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_IMP_else1
  )
"
...
abbreviation "IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_IMP_else2 \<equiv>
  ...
  (invoke_subprogram EQUAL_neq_zero_prefix EQUAL_neq_zero_IMP_Minus);;
  \<comment> \<open>  EQUAL_neq_zero_result = EQUAL_neq_zero_ret EQUAL_neq_zero_ret_state\<close>
  (IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_EQUAL_neq_zero_result) ::= (A (V (EQUAL_neq_zero_prefix @ EQUAL_neq_zero_ret_str)));;
  \<comment> \<open>(if EQUAL_neq_zero_result \<noteq> 0 then\<close>
  (IF IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_EQUAL_neq_zero_result \<noteq>0 THEN
    IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_IMP_if1
  \<comment> \<open>else\<close>
  ELSE
    IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_IMP_else1
...
definition IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_IMP_Minus where
  "IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_IMP_Minus \<equiv>
  \<comment> \<open>  EQUAL_neq_zero_a' = IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_vo s;\<close>
  (EQUAL_neq_zero_prefix @ EQUAL_neq_zero_a_str) ::= (A (V IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_vo_str));;
  ...
  \<comment> \<open>  EQUAL_neq_zero_ret_state = EQUAL_neq_zero_imp EQUAL_neq_zero_state;\<close>
  (invoke_subprogram EQUAL_neq_zero_prefix EQUAL_neq_zero_IMP_Minus);;
  \<comment> \<open>  AND_neq_zero_a' = IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_po s;\<close>
  (AND_neq_zero_prefix @ AND_neq_zero_a_str) ::= (A (V IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_po_str));;
  \<comment> \<open>  AND_neq_zero_b' = EQUAL_neq_zero_ret EQUAL_neq_zero_ret_state;\<close>
  (AND_neq_zero_prefix @ AND_neq_zero_b_str) ::= (A (V (EQUAL_neq_zero_prefix @ EQUAL_neq_zero_ret_str)));;
  \<comment> \<open>  AND_neq_zero_ret' = 0;\<close>
  (AND_neq_zero_prefix @ AND_neq_zero_ret_str) ::= (A (N 0));;
...
abbreviation "IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_IMP_vars \<equiv>
  {IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_n_str, IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_v_str,
  IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_po_str, IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_vo_str,
  IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_ko_str, IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_ret_str,
  IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_AND_neq_zero_result,
  IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_LESS_neq_zero_result,
  IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_EQUAL_neq_zero_result}"

definition "IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_imp_to_HOL_state p s =
  \<lparr>IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_n = (s (add_prefix p IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_n_str)),
   IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_v = (s (add_prefix p IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_v_str)),
   IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_po = (s (add_prefix p IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_po_str)),
   IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_vo = (s (add_prefix p IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_vo_str)),
   IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_ko = (s (add_prefix p IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_ko_str)),
   IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_ret = (s (add_prefix p IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_ret_str))\<rparr>"

lemmas IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_state_translators =
  IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_imp_to_HOL_state_def
  EQUAL_neq_zero_imp_to_HOL_state_def
  AND_neq_zero_imp_to_HOL_state_def
  LESS_neq_zero_imp_to_HOL_state_def

lemma IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_IMP_Minus_correct_function:
  "(invoke_subprogram p IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_IMP_Minus, s) \<Rightarrow>\<^bsup>t\<^esup> s' \<Longrightarrow>
     s' (add_prefix p IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_ret_str)
      = IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_ret
          (IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_imp (IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_imp_to_HOL_state p s))"
  apply(subst IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_imp.simps)
  apply(simp only: IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_IMP_Minus_def prefix_simps)
  apply(erule Seq_E)+
  apply(erule EQUAL_neq_zero_IMP_Minus_correct[where vars = "IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_IMP_vars"])
  subgoal premises p using p(10) by fastforce
  apply(erule AND_neq_zero_IMP_Minus_correct[where vars = "IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_IMP_vars"])
  subgoal premises p using p(12) by fastforce
  apply(erule If_E)
  subgoal
    apply(erule Seq_E)+
    apply(erule LESS_neq_zero_IMP_Minus_correct[where vars = "IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_IMP_vars"])
    subgoal premises p using p(20) by fastforce
    by(fastforce simp: IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_state_translators
      IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_state_upd_def)   
  subgoal
    apply(erule Seq_E)+
    apply(erule EQUAL_neq_zero_IMP_Minus_correct[where vars = "IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_IMP_vars"])
    subgoal premises p using p(20) by fastforce
...
lemma IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_IMP_Minus_correct_effects:
  "\<lbrakk>(invoke_subprogram (p @ IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_pref) IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_IMP_Minus, s) \<Rightarrow>\<^bsup>t\<^esup> s';
    v \<in> vars; \<not> (prefix IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_pref v)\<rbrakk>
   \<Longrightarrow> s (add_prefix p v) = s' (add_prefix p v)"
  using com_add_prefix_valid'' com_only_vars prefix_def
  by blast

lemma IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_IMP_Minus_correct_time:
  "(invoke_subprogram p IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_IMP_Minus, s) \<Rightarrow>\<^bsup>t\<^esup> s' \<Longrightarrow>
     t = IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_imp_time 0 (IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_imp_to_HOL_state p s)"
  apply(subst IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_imp_time.simps)
  apply(simp only: IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_IMP_Minus_def prefix_simps)
  apply(erule Seq_tE)+
  apply(erule EQUAL_neq_zero_IMP_Minus_correct[where vars = "IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_IMP_vars"])
  subgoal premises p using p(19) by fastforce
  ...
  subgoal
    ...
    apply(erule LESS_neq_zero_IMP_Minus_correct[where vars = "IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_IMP_vars"])
    subgoal premises p using p(35) by fastforce
    by(fastforce simp add: Let_def IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_state_translators)   
  subgoal
    apply(erule Seq_tE)+
    apply(erule EQUAL_neq_zero_IMP_Minus_correct[where vars = "IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_IMP_vars"])
    subgoal premises p using p(35) by fastforce
...
lemma IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_IMP_Minus_correct:
  "\<lbrakk>(invoke_subprogram (p1 @ p2) IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_IMP_Minus, s) \<Rightarrow>\<^bsup>t\<^esup> s';
    \<And>v. v \<in> vars \<Longrightarrow> \<not> (set p2 \<subseteq> set v);
    \<lbrakk>t = (IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_imp_time 0 (IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_imp_to_HOL_state (p1 @ p2) s));
     s' (add_prefix (p1 @ p2) IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_ret_str) =
          IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_ret (IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_imp
                                        (IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_imp_to_HOL_state (p1 @ p2) s));
     \<And>v. v \<in> vars \<Longrightarrow> s (add_prefix p1 v) = s' (add_prefix p1 v)\<rbrakk>
   \<Longrightarrow> P\<rbrakk> \<Longrightarrow> P"
  using IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_IMP_Minus_correct_function
    IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_IMP_Minus_correct_time
...
record IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_state =
  IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_n::nat
  IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_v::nat
  IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_po::nat
  IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_vo::nat
  IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_ko::nat
  IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_ret::nat

abbreviation "IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_prefix \<equiv> ''IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3.''"
abbreviation "IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_n_str \<equiv> ''n''"
abbreviation "IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_v_str \<equiv> ''v''"
abbreviation "IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_po_str \<equiv> ''po''"
abbreviation "IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_vo_str \<equiv> ''vo''"
abbreviation "IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_ko_str \<equiv> ''ko''"
abbreviation "IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_ret_str \<equiv> ''ret''"

definition "IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_state_upd s \<equiv>
  (let
      EQUAL_neq_zero_a' = IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_vo s;
      ...
      EQUAL_neq_zero_state = \<lparr>EQUAL_neq_zero_a = EQUAL_neq_zero_a',
                              ...
                              EQUAL_neq_zero_ret = EQUAL_neq_zero_ret'\<rparr>;
      EQUAL_neq_zero_ret_state = EQUAL_neq_zero_imp EQUAL_neq_zero_state;
      AND_neq_zero_a' = IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_po s;
      AND_neq_zero_b' = EQUAL_neq_zero_ret EQUAL_neq_zero_ret_state;
      AND_neq_zero_ret' = 0;
      AND_neq_zero_state = \<lparr>AND_neq_zero_a = AND_neq_zero_a',
                            AND_neq_zero_b = AND_neq_zero_b',
  ...
  (if AND_neq_zero_result \<noteq> 0 then
  (let 
      LESS_neq_zero_a' = IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_ko s;
      LESS_neq_zero_b' = IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_n s;
      LESS_neq_zero_ret' = 0;
      LESS_neq_zero_state = \<lparr>LESS_neq_zero_a = LESS_neq_zero_a',
                             LESS_neq_zero_b = LESS_neq_zero_b',
                             LESS_neq_zero_ret = LESS_neq_zero_ret'\<rparr>;
  ...
  (if LESS_neq_zero_result \<noteq> 0 then
  (let 
      IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_ret' = 1;
      ret = \<lparr>IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_n = IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_n s,
             IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_v = IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_v s,
             IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_po = IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_po s,
             IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_vo = IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_vo s,
             IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_ko = IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_ko s,
  ...
  (let 
      IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_n' = IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_n s;
      IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_v' = IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_v s;
      IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_po' = IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_po s;
      IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_vo' = IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_vo s;
      IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_ko' = IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_ko s;
      IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_ret' = 0;
      IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_state =
        \<lparr>IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_n = IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_n',
         IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_v = IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_v',
         IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_po = IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_po',
         IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_vo = IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_vo',
         IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_ko = IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_ko',
         IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_ret = IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_ret'\<rparr>;
      IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_ret_state =
        IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_imp IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_state;
      IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_ret' = 
        IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_ret IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_ret_state;
      ret = \<lparr>IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_n = IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_n s,
             IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_v = IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_v s,
             IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_po = IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_po s,
             IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_vo = IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_vo s,
...
function IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_imp ::
  "IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_state \<Rightarrow> IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_state" where
  "IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_imp s =
  (let 
      ret = IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_state_upd s
    in 
      ret
  )"
  by simp+
termination
  by (relation "measure IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_n") simp

declare IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_imp.simps [simp del]

lemma IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_imp_correct[let_function_correctness]:
  "IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_ret (IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_imp s) =
    IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3
      (IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_n s) (IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_v s)
      (IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_po s) (IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_vo s)
      (IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_ko s)"
  apply (simp only: IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_imp.simps Let_def 
  IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_state_upd_def EQUAL_neq_zero_imp_correct
  AND_neq_zero_imp_correct LESS_neq_zero_imp_correct IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_imp_correct
  a_encode_char_val IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3.simps)
  by simp

function IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_imp_time ::
  "nat \<Rightarrow> IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_state \<Rightarrow> nat" where
  "IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_imp_time t s =
  (let
      EQUAL_neq_zero_a' = IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_vo s;
      t = t + 2;
      EQUAL_neq_zero_b' = a_encode_char_as_nat;
  ...
  (let 
      ...
      IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_ret_state =
        IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_imp IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_state;
      t = t + IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_imp_time 0 IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_state;
      IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_ret' = 
        IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_ret IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_ret_state;
      t = t + 2;
      ret = \<lparr>IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_n = IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_n s,
  ...
  by auto
termination
  by (relation "measure (IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_n \<circ> snd)") simp

declare IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_imp_time.simps [simp del]

lemma IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_imp_time_acc:
  "(IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_imp_time (Suc t) s) = Suc (IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_imp_time t s)"
  by (induction t s rule: IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_imp_time.induct)
    ((subst (1 2) IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_imp_time.simps);
      (simp add: IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_state_upd_def Let_def))            

lemma IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_imp_time_acc_2_aux:
  "(IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_imp_time t s) = t + (IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_imp_time 0 s)"
  by (induction t arbitrary: s) (simp add: IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_imp_time_acc)+            

lemma IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_imp_time_acc_2:
  "t \<noteq> 0 \<Longrightarrow> (IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_imp_time t s) = t + (IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_imp_time 0 s)"
  by (rule IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_imp_time_acc_2_aux)            

lemma IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_imp_time_acc_3:
  "(IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_imp_time (a + b) s) = a + (IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_imp_time b s)"
  by (induction a arbitrary: b s) (simp add: IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_imp_time_acc)+  

abbreviation "IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_AND_neq_zero_result \<equiv> ''AND_neq_zero_result''"
abbreviation "IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_LESS_neq_zero_result \<equiv> ''LESS_neq_zero_result''"

abbreviation "IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_IMP_if1 \<equiv>
  \<comment> \<open>  IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_ret' = 1;\<close>
  (IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_ret_str) ::= (A (N 1))
"

abbreviation "IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_IMP_else1 \<equiv>
  \<comment> \<open>  IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_ret' = 0;\<close>
  (IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_ret_str) ::= (A (N 0))
"

abbreviation "IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_IMP_if2 \<equiv>
  \<comment> \<open>  LESS_neq_zero_a' = IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_ko s;\<close>
  (LESS_neq_zero_prefix @ LESS_neq_zero_a_str) ::= (A (V IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_ko_str));;
  \<comment> \<open>  LESS_neq_zero_b' = IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_n s;\<close>
  (LESS_neq_zero_prefix @ LESS_neq_zero_b_str) ::= (A (V IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_n_str));;
  \<comment> \<open>  LESS_neq_zero_ret' = 0;\<close>
  (LESS_neq_zero_prefix @ LESS_neq_zero_ret_str) ::= (A (N 0));;
  \<comment> \<open>  LESS_neq_zero_state = \<lparr>LESS_neq_zero_a = LESS_neq_zero_a',\<close>
  \<comment> \<open>                         LESS_neq_zero_b = LESS_neq_zero_b',\<close>
  ...
  (invoke_subprogram LESS_neq_zero_prefix LESS_neq_zero_IMP_Minus);;
  \<comment> \<open>  LESS_neq_zero_result = LESS_neq_zero_ret LESS_neq_zero_ret_state\<close>
  (IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_LESS_neq_zero_result) ::= (A (V (LESS_neq_zero_prefix @ LESS_neq_zero_ret_str)));;
  \<comment> \<open>(if LESS_neq_zero_result \<noteq> 0 then\<close>
  (IF IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_LESS_neq_zero_result \<noteq>0 THEN
    IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_IMP_if1
  \<comment> \<open>else\<close>
  ELSE
    IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_IMP_else1
  )
"

abbreviation "IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_IMP_else2 \<equiv>
  \<comment> \<open>  IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_n' = IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_n s;\<close>
  (IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_prefix @ IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_n_str) ::=
    (A (V IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_n_str));;
  \<comment> \<open>  IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_v' = IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_v s;\<close>
  (IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_prefix @ IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_v_str) ::=
    (A (V IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_v_str));;
  \<comment> \<open>  IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_po' = IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_po s;\<close>
  (IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_prefix @ IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_po_str) ::=
    (A (V IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_po_str));;
  \<comment> \<open>  IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_vo' = IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_vo s;\<close>
  (IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_prefix @ IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_vo_str) ::=
    (A (V IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_vo_str));;
  \<comment> \<open>  IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_ko' = IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_ko s;\<close>
  (IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_prefix @ IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_ko_str) ::=
    (A (V IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_ko_str));;
  \<comment> \<open>  IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_ret' = 0;\<close>
  (IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_prefix @ IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_ret_str) ::= (A (N 0));;
  \<comment> \<open>  IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_state =\<close>
  \<comment> \<open>   \<lparr>IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_n = IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_n',\<close>
  \<comment> \<open>    IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_v = IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_v',\<close>
  \<comment> \<open>    IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_po = IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_po',\<close>
  \<comment> \<open>    IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_vo = IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_vo',\<close>
  \<comment> \<open>    IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_ko = IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_ko',\<close>
  \<comment> \<open>    IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_ret = IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_ret'\<rparr>;\<close>
  \<comment> \<open>  IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_ret_state =\<close>
  \<comment> \<open>    IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_imp IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_state;\<close>
  (invoke_subprogram IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_prefix IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_IMP_Minus);;
  \<comment> \<open>  IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_ret' = \<close>
...
definition IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_IMP_Minus where
  "IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_IMP_Minus \<equiv>
  \<comment> \<open>  EQUAL_neq_zero_a' = IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_vo s;\<close>
  (EQUAL_neq_zero_prefix @ EQUAL_neq_zero_a_str) ::= (A (V IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_vo_str));;
  ...
  \<comment> \<open>  EQUAL_neq_zero_ret_state = EQUAL_neq_zero_imp EQUAL_neq_zero_state;\<close>
  (invoke_subprogram EQUAL_neq_zero_prefix EQUAL_neq_zero_IMP_Minus);;
  \<comment> \<open>  AND_neq_zero_a' = IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_po s;\<close>
  (AND_neq_zero_prefix @ AND_neq_zero_a_str) ::= (A (V IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_po_str));;
  \<comment> \<open>  AND_neq_zero_b' = EQUAL_neq_zero_ret EQUAL_neq_zero_ret_state;\<close>
  (AND_neq_zero_prefix @ AND_neq_zero_b_str) ::= (A (V (EQUAL_neq_zero_prefix @ EQUAL_neq_zero_ret_str)));;
  \<comment> \<open>  AND_neq_zero_ret' = 0;\<close>
  (AND_neq_zero_prefix @ AND_neq_zero_ret_str) ::= (A (N 0));;
  ...
  (invoke_subprogram AND_neq_zero_prefix AND_neq_zero_IMP_Minus);;
  \<comment> \<open>  AND_neq_zero_result = AND_neq_zero_ret AND_neq_zero_ret_state\<close>
  (IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_AND_neq_zero_result) ::= (A (V (AND_neq_zero_prefix @ AND_neq_zero_ret_str)));;
  \<comment> \<open>(if AND_neq_zero_result \<noteq> 0 then\<close>
  (IF IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_AND_neq_zero_result \<noteq>0 THEN
    IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_IMP_if2
  \<comment> \<open>else\<close>
  ELSE
    IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_IMP_else2
  )
"

abbreviation "IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_IMP_vars \<equiv>
  {IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_n_str, IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_v_str,
  IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_po_str, IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_vo_str,
  IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_ko_str, IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_ret_str,
  IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_AND_neq_zero_result, 
  IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_LESS_neq_zero_result}"

definition "IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_imp_to_HOL_state p s =
  \<lparr>IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_n = (s (add_prefix p IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_n_str)),
   IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_v = (s (add_prefix p IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_v_str)),
   IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_po = (s (add_prefix p IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_po_str)),
   IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_vo = (s (add_prefix p IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_vo_str)),
   IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_ko = (s (add_prefix p IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_ko_str)),
   IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_ret = (s (add_prefix p IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_ret_str))\<rparr>"

lemmas IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_state_translators =
...
lemma IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_IMP_Minus_correct_function:
  "(invoke_subprogram p IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_IMP_Minus, s) \<Rightarrow>\<^bsup>t\<^esup> s' \<Longrightarrow>
     s' (add_prefix p IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_ret_str)
      = IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_ret
          (IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_imp (IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_imp_to_HOL_state p s))"
  apply(subst IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_imp.simps)
  apply(simp only: IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_IMP_Minus_def prefix_simps)
  apply(erule Seq_E)+
  apply(erule EQUAL_neq_zero_IMP_Minus_correct[where vars = "IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_IMP_vars"])
  subgoal premises p using p(10) by fastforce
  apply(erule AND_neq_zero_IMP_Minus_correct[where vars = "IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_IMP_vars"])
  subgoal premises p using p(12) by fastforce
  apply(erule If_E)
  subgoal
    apply(erule Seq_E)+
    apply(erule LESS_neq_zero_IMP_Minus_correct[where vars = "IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_IMP_vars"])
    subgoal premises p using p(20) by fastforce
    by(fastforce simp: IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_state_translators
      IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_state_upd_def)
  subgoal
    apply(erule Seq_E)+
    apply(erule IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_IMP_Minus_correct[where vars = "IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_IMP_vars"])
    subgoal premises p using p(22) by fastforce
    by(fastforce simp: IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_state_translators
      IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_state_upd_def)     
  done

lemma IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_IMP_Minus_correct_effects:
  "\<lbrakk>(invoke_subprogram (p @ IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_pref) IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_IMP_Minus, s) \<Rightarrow>\<^bsup>t\<^esup> s';
    v \<in> vars; \<not> (prefix IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_pref v)\<rbrakk>
   \<Longrightarrow> s (add_prefix p v) = s' (add_prefix p v)"
  using com_add_prefix_valid'' com_only_vars prefix_def
  by blast

lemma IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_IMP_Minus_correct_time:
  "(invoke_subprogram p IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_IMP_Minus, s) \<Rightarrow>\<^bsup>t\<^esup> s' \<Longrightarrow>
     t = IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_imp_time 0 (IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_imp_to_HOL_state p s)"
  apply(subst IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_imp_time.simps)
  apply(simp only: IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_IMP_Minus_def prefix_simps)
  apply(erule Seq_tE)+
  apply(erule EQUAL_neq_zero_IMP_Minus_correct[where vars = "IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_IMP_vars"])
  subgoal premises p using p(19) by fastforce
  ...
  subgoal
    ...
    apply(erule LESS_neq_zero_IMP_Minus_correct[where vars = "IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_IMP_vars"])
    subgoal premises p using p(35) by fastforce
    by(fastforce simp add: Let_def IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_state_translators)  
  subgoal
    apply(erule Seq_tE)+
    apply(erule IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux2_IMP_Minus_correct[where vars = "IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_IMP_vars"])
    subgoal premises p using p(39) by fastforce
...
lemma IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_IMP_Minus_correct:
  "\<lbrakk>(invoke_subprogram (p1 @ p2) IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_IMP_Minus, s) \<Rightarrow>\<^bsup>t\<^esup> s';
    \<And>v. v \<in> vars \<Longrightarrow> \<not> (set p2 \<subseteq> set v);
    \<lbrakk>t = (IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_imp_time 0 (IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_imp_to_HOL_state (p1 @ p2) s));
     s' (add_prefix (p1 @ p2) IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_ret_str) =
          IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_ret (IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_imp
                                        (IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_imp_to_HOL_state (p1 @ p2) s));
     \<And>v. v \<in> vars \<Longrightarrow> s (add_prefix p1 v) = s' (add_prefix p1 v)\<rbrakk>
   \<Longrightarrow> P\<rbrakk> \<Longrightarrow> P"
  using IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_IMP_Minus_correct_function
    IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux3_IMP_Minus_correct_time
...
record IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux4_state =
  ...
  IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux4_vo::nat
  IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux4_ko::nat

abbreviation "IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux4_prefix \<equiv> ''IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux4.''"
abbreviation "IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux4_v_str \<equiv> ''v''"
abbreviation "IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux4_po_str \<equiv> ''po''"
abbreviation "IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux4_vo_str \<equiv> ''vo''"
abbreviation "IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux4_ko_str \<equiv> ''ko''"

definition "IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux4_state_upd s \<equiv>
  (let
      var_to_operand_bit_tail_v' = IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux4_v s;
      var_to_operand_bit_tail_ret' = 0;
      ...
      snd'_state = \<lparr>snd'_state_p = snd'_state_p'\<rparr>;
      snd'_ret_state = snd'_imp snd'_state;
      IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux4_po' = var_to_operand_bit_tail_result;
      IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux4_vo' = fst'_result;
      IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux4_ko' = snd'_state_p snd'_ret_state;
      ret = \<lparr>IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux4_v = IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux4_v s,
...
function IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux4_imp ::
  "IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux4_state \<Rightarrow> IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux4_state" where
  "IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux4_imp s =
  (let 
      ret = IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux4_state_upd s
    in 
      ret
  )"
  by simp+
termination
  by (relation "measure IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux4_v") simp

declare IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux4_imp.simps [simp del]

lemma IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux4_imp_correct_po[let_function_correctness]:
  "IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux4_po (IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux4_imp s) =
    var_to_operand_bit_tail (IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux4_v s)"
  apply (simp only: IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux4_imp.simps Let_def
  IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux4_state_upd_def var_to_operand_bit_tail_imp_correct)
  by simp     

lemma IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux4_imp_correct_vo[let_function_correctness]:
  "IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux4_vo (IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux4_imp s) =
    fst_nat (var_to_operand_bit_tail (IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux4_v s) - 1)"
  apply (simp only: IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux4_imp.simps Let_def
  IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux4_state_upd_def
  var_to_operand_bit_tail_imp_correct fst'_imp_correct fst_nat_fst'_nat)
  by simp     

lemma IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux4_imp_correct_ko[let_function_correctness]:
  "IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux4_ko (IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux4_imp s) =
    snd_nat (var_to_operand_bit_tail (IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux4_v s) - 1)"
  apply (simp only: IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux4_imp.simps Let_def
  IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux4_state_upd_def
  var_to_operand_bit_tail_imp_correct snd'_imp_correct snd_nat_snd'_nat)
  by simp   

function IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux4_imp_time ::
  "nat \<Rightarrow> IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux4_state \<Rightarrow> nat" where
  "IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux4_imp_time t s =
  (let
      var_to_operand_bit_tail_v' = IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux4_v s;
      t = t + 2;
      var_to_operand_bit_tail_ret' = 0;
  ...
  by auto
termination
  by (relation "measure (IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux4_v \<circ> snd)") simp

declare IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux4_imp_time.simps [simp del]

lemma IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux4_imp_time_acc:
  "(IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux4_imp_time (Suc t) s) = Suc (IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux4_imp_time t s)"
  by (induction t s rule: IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux4_imp_time.induct)
    ((subst (1 2) IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux4_imp_time.simps);
      (simp add: IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux4_state_upd_def Let_def))            

lemma IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux4_imp_time_acc_2_aux:
  "(IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux4_imp_time t s) = t + (IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux4_imp_time 0 s)"
  by (induction t arbitrary: s) (simp add: IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux4_imp_time_acc)+            

lemma IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux4_imp_time_acc_2:
  "t \<noteq> 0 \<Longrightarrow> (IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux4_imp_time t s) = t + (IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux4_imp_time 0 s)"
  by (rule IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux4_imp_time_acc_2_aux)            

lemma IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux4_imp_time_acc_3:
  "(IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux4_imp_time (a + b) s) = a + (IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux4_imp_time b s)"
  by (induction a arbitrary: b s) (simp add: IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux4_imp_time_acc)+       

abbreviation "IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux4_var_to_operand_bit_tail_result \<equiv> ''var_to_operand_bit_tail_result''"
abbreviation "IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux4_fst'_result \<equiv> ''fst'_result''"

definition IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux4_IMP_Minus where
  "IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux4_IMP_Minus \<equiv>
  \<comment> \<open>  var_to_operand_bit_tail_v' = IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux4_v s;\<close>
  (var_to_operand_bit_tail_prefix @ var_to_operand_bit_tail_v_str) ::=
    (A (V IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux4_v_str));;
  \<comment> \<open>  var_to_operand_bit_tail_ret' = 0;\<close>
  ...
  (invoke_subprogram var_to_operand_bit_tail_prefix var_to_operand_bit_tail_IMP_Minus);;
  \<comment> \<open>  var_to_operand_bit_tail_result = var_to_operand_bit_tail_ret var_to_operand_bit_tail_ret_state;\<close>
  (IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux4_var_to_operand_bit_tail_result) ::=
  ...
  (fst'_prefix @ fst'_p_str) ::= (Sub (V IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux4_var_to_operand_bit_tail_result) (N 1));;
  \<comment> \<open>  fst'_state = \<lparr>fst'_state_p = fst'_state_p'\<rparr>;\<close>
  \<comment> \<open>  fst'_ret_state = fst'_imp fst'_state;\<close>
  (invoke_subprogram fst'_prefix fst'_IMP_Minus);;
  \<comment> \<open>  fst'_result = fst'_state_p fst'_ret_state;\<close>
  (IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux4_fst'_result) ::= (A (V (fst'_prefix @ fst'_p_str)));;
  \<comment> \<open>  snd'_state_p' = var_to_operand_bit_tail_result - 1;\<close>
  (snd'_prefix @ snd'_p_str) ::= (Sub (V IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux4_var_to_operand_bit_tail_result) (N 1));;
  \<comment> \<open>  snd'_state = \<lparr>snd'_state_p = snd'_state_p'\<rparr>;\<close>
  \<comment> \<open>  snd'_ret_state = snd'_imp snd'_state;\<close>
  (invoke_subprogram snd'_prefix snd'_IMP_Minus);;
  \<comment> \<open>  IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux4_po' = var_to_operand_bit_tail_result;\<close>
  (IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux4_po_str) ::=
    (A (V IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux4_var_to_operand_bit_tail_result));;
  \<comment> \<open>  IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux4_vo' = fst'_result;\<close>
  (IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux4_vo_str) ::=
    (A (V IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux4_fst'_result));;
  \<comment> \<open>  IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux4_ko' = snd'_state_p snd'_ret_state;\<close>
    (IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux4_ko_str) ::=
    (A (V (snd'_prefix @ snd'_p_str)))
"

abbreviation "IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux4_IMP_vars \<equiv>
  {IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux4_v_str, IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux4_po_str,
  IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux4_vo_str, IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux4_ko_str, 
  IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux4_var_to_operand_bit_tail_result, 
  IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux4_fst'_result}"

definition "IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux4_imp_to_HOL_state p s =
  \<lparr>IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux4_v = (s (add_prefix p IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux4_v_str)),
   IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux4_po = (s (add_prefix p IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux4_po_str)),
   IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux4_vo = (s (add_prefix p IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux4_vo_str)),
   IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux4_ko = (s (add_prefix p IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux4_ko_str))\<rparr>"

lemmas IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux4_state_translators =
  IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux4_imp_to_HOL_state_def
  var_to_operand_bit_tail_imp_to_HOL_state_def
  fst'_imp_to_HOL_state_def
  snd'_imp_to_HOL_state_def

lemma IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux4_IMP_Minus_correct_function_po:
  "(invoke_subprogram p IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux4_IMP_Minus, s) \<Rightarrow>\<^bsup>t\<^esup> s' \<Longrightarrow>
     s' (add_prefix p IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux4_po_str)
      = IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux4_po
          (IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux4_imp (IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux4_imp_to_HOL_state p s))"
  apply(subst IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux4_imp.simps)
  apply(simp only: IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux4_IMP_Minus_def prefix_simps)
  apply(erule Seq_E)+
  apply(erule var_to_operand_bit_tail_IMP_Minus_correct[where vars = "IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux4_IMP_vars"])
  subgoal premises p using p(12) by fastforce
  apply(erule fst'_IMP_Minus_correct[where vars = "IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux4_IMP_vars"])
  subgoal premises p using p(14) by fastforce
  apply(erule snd'_IMP_Minus_correct[where vars = "IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux4_IMP_vars"])
  subgoal premises p using p(16) by fastforce
  by(fastforce_sorted_premises2 simp: IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux4_state_upd_def
      Let_def IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux4_state_translators)

lemma IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux4_IMP_Minus_correct_function_vo:
  "(invoke_subprogram p IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux4_IMP_Minus, s) \<Rightarrow>\<^bsup>t\<^esup> s' \<Longrightarrow>
     s' (add_prefix p IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux4_vo_str)
      = IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux4_vo
          (IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux4_imp (IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux4_imp_to_HOL_state p s))"
  apply(subst IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux4_imp.simps)
  apply(simp only: IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux4_IMP_Minus_def prefix_simps)
  apply(erule Seq_E)+
...
lemma IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux4_IMP_Minus_correct_function_ko:
  "(invoke_subprogram p IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux4_IMP_Minus, s) \<Rightarrow>\<^bsup>t\<^esup> s' \<Longrightarrow>
     s' (add_prefix p IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux4_ko_str)
      = IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux4_ko
          (IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux4_imp (IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux4_imp_to_HOL_state p s))"
  apply(subst IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux4_imp.simps)
  apply(simp only: IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux4_IMP_Minus_def prefix_simps)
  apply(erule Seq_E)+
...
lemma IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux4_IMP_Minus_correct_effects:
  "\<lbrakk>(invoke_subprogram (p @ IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux4_pref) IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux4_IMP_Minus, s) \<Rightarrow>\<^bsup>t\<^esup> s';
    v \<in> vars; \<not> (prefix IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux4_pref v)\<rbrakk>
   \<Longrightarrow> s (add_prefix p v) = s' (add_prefix p v)"
  using com_add_prefix_valid'' com_only_vars prefix_def
  by blast     

lemma IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux4_IMP_Minus_correct_time:
  "(invoke_subprogram p IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux4_IMP_Minus, s) \<Rightarrow>\<^bsup>t\<^esup> s' \<Longrightarrow>
     t = IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux4_imp_time 0 (IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux4_imp_to_HOL_state p s)"
  apply(subst IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux4_imp_time.simps)
  apply(simp only: IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux4_IMP_Minus_def prefix_simps)
  apply(erule Seq_tE)+
  apply(erule var_to_operand_bit_tail_IMP_Minus_correct[where vars = "IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux4_IMP_vars"])
  subgoal premises p using p(23) by fastforce
  ...
  apply(erule snd'_IMP_Minus_correct[where vars = "IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux4_IMP_vars"])
  subgoal premises p using p(27) by fastforce
  by(fastforce_sorted_premises2 simp: Let_def IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux4_state_translators)  

lemma IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux4_IMP_Minus_correct:
  "\<lbrakk>(invoke_subprogram (p1 @ p2) IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux4_IMP_Minus, s) \<Rightarrow>\<^bsup>t\<^esup> s';
    \<And>v. v \<in> vars \<Longrightarrow> \<not> (set p2 \<subseteq> set v);
    \<lbrakk>t = (IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux4_imp_time 0 (IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux4_imp_to_HOL_state (p1 @ p2) s));
     s' (add_prefix (p1 @ p2) IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux4_po_str) =
          IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux4_po (IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux4_imp
                                        (IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux4_imp_to_HOL_state (p1 @ p2) s));
     s' (add_prefix (p1 @ p2) IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux4_vo_str) =
          IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux4_vo (IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux4_imp
                                        (IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux4_imp_to_HOL_state (p1 @ p2) s));
     s' (add_prefix (p1 @ p2) IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux4_ko_str) =
          IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux4_ko (IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux4_imp
                                        (IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux4_imp_to_HOL_state (p1 @ p2) s));
     \<And>v. v \<in> vars \<Longrightarrow> s (add_prefix p1 v) = s' (add_prefix p1 v)\<rbrakk>
   \<Longrightarrow> P\<rbrakk> \<Longrightarrow> P"
  using IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux4_IMP_Minus_correct_function_po
    IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux4_IMP_Minus_correct_function_vo
    IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux4_IMP_Minus_correct_function_ko
    IMP_Minus_State_To_IMP_Minus_Minus_partial_tail_aux4_IMP_Minus_correct_time
