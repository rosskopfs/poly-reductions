...
theory Landau_Auxiliaries
  imports "Akra_Bazzi.Akra_Bazzi_Method" "HOL-Library.Discrete_Functions" "HOL-Real_Asymp.Real_Asymp"
begin

lemma dlog_Suc_bound: "floor_log (Suc a) \<le> Suc (floor_log a)"
  by (metis floor_log_le_iff Suc_le_eq log_exp log_exp2_gt power_Suc)
...
lemma log2_floor_dlog_bound:
  ...
  by (metis floor_log_le_iff assms log2_of_power_le log_exp nat_ceiling_le_eq nat_le_linear not_less_eq_eq plus_1_eq_Suc)
