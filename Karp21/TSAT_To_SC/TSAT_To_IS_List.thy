...
theory TSAT_To_IS_List
  imports TSAT_To_IS IS_Definition_List
begin
...
subsection \<open>@{term sat_is_list} is a reduction from @{term three_cnf_sat_list} to
@{term independent_set_list}.\<close>

theorem is_reduction_sat_is_list: "is_reduction sat_is_list three_cnf_sat_list independent_set_list"
  unfolding three_cnf_sat_list_def independent_set_list_def
  using is_reduction_sat_is[unfolded three_cnf_sat_eq_Collect_three_cnf_sat_pred
