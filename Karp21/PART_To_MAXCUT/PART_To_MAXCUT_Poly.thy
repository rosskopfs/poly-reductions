...
definition "part_to_max_cut_time n ≡ n + n * n + n"
...
unfolding SPEC_def part_to_max_cut_def size_part_def part_to_max_cut_time_def
  part_to_max_cut_poly_def mop_list_up_to_def mop_all_edges_def mop_sum_list_def
apply(rule T_specifies_I)
apply(vcg' \<open>-\<close> rules: T_SPEC)
by simp

theorem part_to_max_cut_ispolyred: "ispolyred part_to_max_cut_poly part_alter max_cut size_part size_max_cut"
