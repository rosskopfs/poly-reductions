theory ChrN_To_CC
  imports Main "../TC_To_ChrN/TC_To_ChrN" "../CNF_SAT_To_Clique/CNF_SAT_To_Clique"
...
proof -
  ...
  have card_e: "\<forall>e\<in>E. card e = 2" 
    using assms unfolding is_k_colorable_def chromaticNumber_def is_colorable_def ugraph_def
    by fast
  moreover{
    have "finite C_sets"
...
theorem is_reduction_chrn_to_cc:
  "is_reduction chrN_to_cc chromaticNumber clique_cover"
  unfolding is_reduction_def 
  using chrN_to_cc_sound chrN_to_cc_complete
  by auto
